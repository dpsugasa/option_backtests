            ...
            header=dict(height = 15,
                        ...
                        cells = dict(values= [['ISIN',
                                    ...
                                    [m['SANTAN 6.25']['ID_ISIN'].item(),
                                     ...
                                     np.round(hp['tot_ret'].tail(1).item(),3),
            ...
            header=dict(height = 15,
                        ...
                        cells = dict(values= [['ISIN',
                                    ...
                                    [m['SANTAN 6.25']['ID_ISIN'].item(),
                                     ...
                                     m['SANTAN 6.25']['ISSUE_DT'],
                                     m['SANTAN 6.25']['NXT_CALL_DT'],
                                     np.round(hp2['tot_ret'].tail(1).item(),3),
                                     np.round(n['SANTAN 6.25']['cum_cpn'].tail(1).item(),3),
                                     np.round(n['SANTAN 6.25']['cum_f'].tail(1).item(),3),
                                     np.round(d['SANTAN 6.25']['LAST PRICE'].tail(1),3),                                     
                                     sharpe_ratio(hp2['t_ret']),
                                     sharpe_ratio(hp2['t_ret'].resample('BM').sum().values, 12),
                                     sharpe_ratio(hp2['t_ret'].resample('W').sum().values, 52),
                                     max_DD(hp2['tot_ret'])]],
                            line = dict(color='#7D7F80'),
                            fill = dict(color='#EDFAFF'),
                            align = ['left'] * 5))
            ...
            header=dict(height = 15,
                        ...
                        cells = dict(values= [['ISIN',
                                    ...
                                    [m['SOCGEN 6']['ID_ISIN'].item(),
                                     ...
                                     np.round(hp3['tot_ret'].tail(1).item(),3),
                                     ...
                                     sharpe_ratio(hp3['t_ret'].resample('BM').sum().values, 12),
                                     sharpe_ratio(hp3['t_ret'].resample('W').sum().values, 52),
                                     max_DD(hp3['tot_ret'])]],
                            line = dict(color='#7D7F80'),
                            fill = dict(color='#EDFAFF'),
                            align = ['left'] * 5))
